""" To compile the .ui file created with Qt Designer into a  Python file do the following:
    ...
    C:\Users\QMDla\Documents\Python Scripts\02 QMDLAB Data Collection\v3.3\Sub_Scripts pyuic4 GUI.ui>GUI.py"""
...
#from Tabs.Keithley_Stepper import Keithley_Stepper
from Tabs.Lock_In import Lock_In
from Tabs.List_Visas import List_Visas
...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.connect(self.ui.actionKeithley_Double_Scan, SIGNAL('triggered()'), lambda : self.ui.stackedWidget.setCurrentIndex(4))
